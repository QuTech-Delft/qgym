"""
A dictionary of spaces, i.e. a dictionary with fixed string keys and space( sample)s as values.
"""
import typing
...
class Dict(gym.spaces.Dict):
    ...
    def __init__(
        ...
        **spaces_kwargs: gym.Space
        ...
        :param spaces: Dictionary containing string valued keys and spaces that are to form this Dictionary space.
