...
environments for the different passes of the OpenQL framework, by simply initializing a
...
Example:
    We want to create a environment for the OpenQL pass of initial mapping for a system
