...
def test_routing_state_initialize(
    max_interaction_gates, max_observation_reach, quad_graph
):
    state = RoutingState(
...
def test_routing_state(max_interaction_gates, max_observation_reach, quad_graph):
    state = RoutingState(
        max_interaction_gates=max_interaction_gates,
        max_observation_reach=max_observation_reach,
        connection_graph=quad_graph,
    ...
    #   surpassing
    flag = state.observation_reach == len(
        state.obtain_observation()["interaction_gates_ahead"]
    )
