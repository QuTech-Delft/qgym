...
srcmod_dir = pysrc_dir  + os.sep + 'qgym'       # qgym Python module directory, source files only
module_dir = target_dir + os.sep + 'qgym'       # qgym Python module directory for editable install
